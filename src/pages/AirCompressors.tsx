...
export const AirCompressors: React.FC = () => {
  ...
  const maxCarouselIndex = Math.max(0, airCompressorProducts.length - 1);
  ...
  const currentProduct = airCompressorProducts[carouselIndex];
    ...
    <>
          ...
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ display: 'flex', gap: 1, mt: 2, justifyContent: 'center' }}>
                {airCompressorProducts.map((_, index) => (
                  <Box
                    key={index}
                    onClick={() => {
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Professional air compression equipment and diagnostic tools
              </Typography>
              <Button
      ...
      <Container maxWidth="lg" sx={{ py: 10 }}>
        <Typography variant="h3" sx={{ fontWeight: 900, mb: 6, textAlign: 'center', color: '#1a1a1a' }}>
          All Air Compressors & Systems
        </Typography>
        <Grid container spacing={3}>
          {airCompressorProducts.map((product) => (
