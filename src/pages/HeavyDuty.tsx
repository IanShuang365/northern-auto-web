...
export const HeavyDuty: React.FC = () => {
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <Box sx={{ bgcolor: '#f5f5f5', py: 8 }}>
        <Container maxWidth="lg">
          ...
          >
            Heavy Duty Equipment Solutions
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            Industrial-grade equipment designed for heavy-duty service operations and commercial fleet maintenance.
          </Typography>
        </Container>
      </Box>
      ...
      <Box sx={{ bgcolor: '#f5f5f5', py: 8 }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center' }}>
            ...
            >
              Power Your Heavy Duty Operations
            </Typography>
            <Typography
              sx={{
                color: '#666',
            ...
            >
              Get the rugged, reliable equipment your commercial fleet operations need.
            </Typography>
            <Button
              variant="contained"
              size="large"
