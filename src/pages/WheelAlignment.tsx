...
export const WheelAlignment: React.FC = () => {
  ...
  const maxCarouselIndex = Math.max(0, alignmentProducts.length - 1);
  ...
  const currentProduct = alignmentProducts[carouselIndex];
    ...
    <>
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Precision alignment systems and diagnostic tools for perfect wheel geometry
              </Typography>
              <Button
      ...
      <Container maxWidth="lg" sx={{ py: 10 }}>
        <Typography variant="h3" sx={{ fontWeight: 900, mb: 6, textAlign: 'center', color: '#1a1a1a' }}>
          All Alignment Equipment
        </Typography>
        <Grid container spacing={3}>
          {alignmentProducts.map((product) => (
