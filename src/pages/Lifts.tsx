...
export const Lifts: React.FC = () => {
  ...
  const maxCarouselIndex = Math.max(0, liftsProducts.length - 1);
  ...
  const currentProduct = liftsProducts[carouselIndex];
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Industrial lifting equipment for vehicle maintenance and service
              </Typography>
              <Button
